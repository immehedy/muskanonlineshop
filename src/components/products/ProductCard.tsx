...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group relative bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100/50 backdrop-blur-sm">
      ...
      <Link href={`/products/${fields.slug}`} className="block h-full">
        ...
        <div className="relative aspect-[6/5] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          {fields.stockQty <= 0 && (
            <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center">
              <div className="bg-white/95 text-gray-900 font-semibold px-3 py-1.5 rounded-full shadow-lg text-sm">
                Out of Stock
              </div>
            </div>
          )}
          ...
          {fields.stockQty > 0 && fields.stockQty <= 5 && (
            <div className="absolute bottom-2 left-2 bg-orange-500/90 backdrop-blur-sm text-white text-xs font-medium px-2 py-1 rounded-full">
        ...
        <div className="p-2.5 space-y-1.5">
          ...
          <h3 className="text-sm font-semibold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent line-clamp-2 group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
            {fields.title}
          </h3>
